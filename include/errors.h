...
#define UNEXPECTED_OPERATOR                (ERROR_INDICATOR + "Unexpected operator '" + token_operator(tokenof(context)) + "'")
#define UNEXPECTED_OPERATOR_INEXP          (ERROR_INDICATOR + "Unexpected operator '" + token_operator(tokenof(context)) + "' in expression")
#define UNEXPECTED_WORD                    (ERROR_INDICATOR + "Unexpected identifier '" + tokendata(context) + "'")
#define UNEXPECTED_WORD_AFTER_VARNAME(a)   (ERROR_INDICATOR + "Unexpected identifier '" + tokendata(context) + "' after variable '" + a + "'")
