...
OBJ_DEBUG = $(OBJDIR_DEBUG)\\source\\assembler.o $(OBJDIR_DEBUG)\\source\\enforcer.o $(OBJDIR_DEBUG)\\source\\file.o $(OBJDIR_DEBUG)\\source\\lexer.o $(OBJDIR_DEBUG)\\source\\main.o $(OBJDIR_DEBUG)\\source\\management.o $(OBJDIR_DEBUG)\\source\\options.o $(OBJDIR_DEBUG)\\source\\token.o

OBJ_RELEASE = $(OBJDIR_RELEASE)\\source\\assembler.o $(OBJDIR_RELEASE)\\source\\enforcer.o $(OBJDIR_RELEASE)\\source\\file.o $(OBJDIR_RELEASE)\\source\\lexer.o $(OBJDIR_RELEASE)\\source\\main.o $(OBJDIR_RELEASE)\\source\\management.o $(OBJDIR_RELEASE)\\source\\options.o $(OBJDIR_RELEASE)\\source\\token.o
